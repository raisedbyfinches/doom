...
;;
;;; Commentary: Modified November 2025 to reduce visual complexity
;;; Code:
...
(def-doom-theme doom-horizon
  ...
  ((bg         '("#232530" nil       nil            ))
   ...
   (selection      violet)
   (builtin        fg)
   (comments       (if doom-horizon-brighter-comments red hor-highlight-bright))
   (doc-comments   yellow)
   (constants      orange)
   (functions      orange)
   (keywords       fg)
  ...
  (((font-lock-comment-face &override)
   ...
   (tooltip :background base0 :foreground fg)
    ...
    ;;;; haskell
   (haskell-operator-face :foreground fg-alt)
   (font-lock-operator-face :foreground (doom-darken fg 0.35))
   ;;;; ess
   (ess-%op%-face :foreground (doom-darken fg 0.35))
   (ess-numbers-face :foreground red)
   (ess-operator-face :foreground (doom-darken fg 0.35))
   (ess-assignment-face :foreground (doom-darken fg 0.35))
   (ess-function-call-face :foreground fg)
   ...
   (markdown-link-face             :foreground fg :weight 'bold)
   ...
   (markdown-markup-face           :foreground fg)
   (markdown-bold-face             :foreground fg)
   (markdown-table-face            :foreground fg :background (doom-darken bg 0.2))
   ((markdown-code-face &override) :foreground orange :background (doom-darken bg 0.1))
   ;;;; orderless
